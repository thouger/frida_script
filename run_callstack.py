...
Frida 调用栈打印启动器
使用方法:
  python run_callstack.py -o 0x1B98F4
  python run_callstack.py -o 1B98F4 -s libmetasec_ml.so
"""
...
def main():
    parser = argparse.ArgumentParser(description='Frida 调用栈打印工具')
    ...
    parser.add_argument('--script', default='callstack.js', help='Frida 脚本路径 (默认: callstack.js)')
