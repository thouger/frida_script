function main() {
    Java.perform(function () {
        console.log("hook StringBuffer")
        var Map = Java.use('java.lang.StringBuffer');
        Map.append.implementation = function (str) {
            console.log("=================StringBuffer.put====================");
            var data = this.append(str);
            console.log("-----" + str + "-----");
